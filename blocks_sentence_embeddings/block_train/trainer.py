...
from .model import EmbeddingModel, EmbeddingModelQwen, EmbeddingModelQwen2
...
class SentenceTrainer(Trainer):
    def compute_loss(
        self,
        model: EmbeddingModel | EmbeddingModelQwen | EmbeddingModelQwen2,
        inputs,
        **kwargs,
    ):
        query = inputs["query"]
        ...
        if self.args.embedding_model_name == "qwen2":#isinstance(model, EmbeddingModelQwen2) or
