...
class ModelArguments:
    model_name_or_path: Optional[str] = field(default="Qwen1.5-7B-Chat")
    use_lora: Optional[bool] = field(default=False)


@dataclass
class DataArguments:
    data_path: str = field(default="./data", metadata={
...
def load_dataset_from_path(data_path: Optional[str] = None,
    ...
    logger.info(f"当前数据路径为：{all_file_list}")
